...
describe("scan amount accessibility", () => {
  it("exposes pressed presets and linked invalid-input help", () => {
    const markup = renderToStaticMarkup(<ScanForm amount="1000" loading={false} invalidMessage="Amount is invalid" onAmountChange={() => undefined} onPreset={() => undefined} onSubmit={() => undefined} />);
